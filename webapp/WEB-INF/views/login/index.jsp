	...
	<div class="container">
		<div class="forms-container">
			<div class="signin-signup">
				<form method="post" action="${pageContext.request.contextPath}/login" class="sign-in-form">
		...
		<div class="panels-container">
			<div class="panel left-panel">
				...
				<img src="${pageContext.request.contextPath}/assets/images/log.svg"
					class="image" alt="" />
			</div>
			<div class="panel right-panel">
				...
				<img
					src="${pageContext.request.contextPath}/assets/images/register.svg"
					class="image" alt="" />
			</div>
		</div>
	</div>
