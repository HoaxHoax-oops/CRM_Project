...
<!-- End Breadcrumb -->
	...
	<div class="container page__container">
		<div class="card">
			...
			<div class="card-body">
				<button type="button" class="btn btn-warning d-inline-flex" 
					data-toggle="toastr" data-toastr-type="warning" 
					data-toastr-title="Heads up!" 
					data-toastr-message="Check below fields please.">Click me
            	</button>
				<div class="chart">
